...
exports.main = async (event, callback) => {
    ...
    try {
        ...
        const staticMapUrl = `https://api.mapbox.com/styles/v1/<YOUR-INSTANCE-NAME-HERE>/<STYLES-ID-HERE>/static/pin-s-a+fac910(${fromCoordinates.join(',')}),pin-s-b+f44f64(${toCoordinates.join(',')}),path-5+fac910-1(${encodeURIComponent(polyline)})/auto/300x300?access_token=${MAPBOX_KEY}`;
