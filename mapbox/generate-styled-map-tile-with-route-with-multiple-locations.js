...
exports.main = async (event, callback) => {
    ...
    try {
        ...
        const staticMapUrl = `https://api.mapbox.com/styles/v1/anyvan/clz310p7m00n201pch4cahn3g/static/${markers},path-5+fac910-1(${encodeURIComponent(polyline)})/auto/300x300?access_token=${mapboxAccessToken}`;
