...
async function logSuccessToDatadog(message, contactId, email, import_type, locale, last_twilio_call_timestamp_string, last_twilio_call_tags, last_twilio_call_outcome, last_twilio_call_direction, last_twilio_call_id, last_twilio_call_sid, last_twilio_team_id_engage, csat_score_rating__0_10_, last_twilio_csat_survey_call_sid) {
    const datadogEndpoint = 'https://http-intake.logs.datadoghq.eu/v1/input';
    const logData = {
        ddsource: 'hubspot',
        ddtags: 'hubspot, hs-csat-log',
        ...
        last_twilio_team_id_engage:last_twilio_team_id_engage,
        csat_score_rating__0_10_: csat_score_rating__0_10_,
        last_twilio_csat_survey_call_sid: last_twilio_csat_survey_call_sid,
...
exports.main = async (event) => {
    ...
    const csat_score_rating__0_10_ = event.inputFields.csat_score_rating__0_10_;
    const last_twilio_csat_survey_call_sid = event.inputFields.last_twilio_csat_survey_call_sid;

    if (email) {
        try {
            // Log success to Datadog
            await logSuccessToDatadog('Call logged successfully to Datadog', contactId, email, import_type, locale, last_twilio_call_timestamp_string, last_twilio_call_tags, last_twilio_call_outcome, last_twilio_call_direction, last_twilio_call_id, last_twilio_call_sid, last_twilio_team_id_engage, csat_score_rating__0_10_, last_twilio_csat_survey_call_sid);
        } catch (error) {
